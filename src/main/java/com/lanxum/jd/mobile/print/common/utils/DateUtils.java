...
//	}
	...
	public static long diffMin(Date one, Date two) {

		long l = one.getTime() - two.getTime();
     ...
     * @return 返回日期数组
     */
    public static List<String> getDatesFromBegToEnd(String startAt, String endAt) {
        List<String> dates = new ArrayList<>();
        try {
            Date startDate = dateFormat.parse(startAt);
            Date endDate = dateFormat.parse(endAt);
            dates.addAll(getDatesFromBegToEnd(startDate, endDate));
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return dates;
     ...
     * @return 返回日期数组
     */
    public static List<String> getDatesFromBegToEnd(Date startAt, Date endAt) {
        List<String> dates = new ArrayList<>();
